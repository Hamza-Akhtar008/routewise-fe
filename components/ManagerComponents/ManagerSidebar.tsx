...
export function ManagerSidebar({ isOpen, setIsOpen }: SidebarProps) {
  ...
  const sidebarItems: SidebarItem[] = [
    ...
    { title: "Tasks", href: "/manager-dashboard/tasks", icon: ListTodo },
    { title: "Schedule", href: "/manager-dashboard/schedule", icon: Calendar },
    { title: "Drivers", href: "/manager-dashboard/drivers", icon: Users },
    { title: "Performance", href: "/manager-dashboard/performance", icon: BarChart2 },
    { title: "Routes", href: "/manager-dashboard/routes", icon: Map },
    { title: "Fuel Tracks", href: "/manager-dashboard/fuel", icon: Fuel },
    { title: "Maintenance", href: "/manager-dashboard/maintenance", icon: Wrench },
    { title: "Tow Service", href: "/manager-dashboard/tow-service", icon: Truck },
    { title: "Accidents", href: "/manager-dashboard/accidents", icon: AlertTriangle },
    { title: "PTO", href: "/manager-dashboard/pto", icon: Palmtree },
    { title: "Expenses", href: "/manager-dashboard/expenses", icon: Receipt },
    { title: "Handbooks", href: "/manager-dashboard/handbooks", icon: BookOpen },
  ];
      ...
      <div className="border-t p-4 shrink-0">
        <div className="flex items-center gap-3">
          <Avatar className="h-8 w-8">
            <AvatarImage src="/placeholder-user.jpg" alt="Mike Manager" />
