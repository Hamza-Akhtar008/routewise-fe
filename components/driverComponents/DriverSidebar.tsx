...
export function DriverSidebar({ isOpen, setIsOpen }: SidebarProps) {
  ...
  const sidebarItems: SidebarItem[] = [
    ...
    { title: "Tasks", href: "/driver-dashboard/tasks", icon: ListTodo },
    { title: "Schedule", href: "/driver-dashboard/schedule", icon: Calendar },
    { title: "Routes", href: "/driver-dashboard/routes", icon: Map },
    { title: "Fuel Tracks", href: "/driver-dashboard/fuel", icon: Fuel },
    { title: "Maintenance", href: "/driver-dashboard/maintenance", icon: Wrench },
    { title: "Tow Service", href: "/driver-dashboard/tow-service", icon: Truck },
    { title: "Accidents", href: "/driver-dashboard/accidents", icon: AlertTriangle },
    { title: "PTO", href: "/driver-dashboard/pto", icon: Palmtree },
    { title: "Expenses", href: "/driver-dashboard/expenses", icon: Receipt },
    { title: "Handbooks", href: "/driver-dashboard/handbooks", icon: BookOpen },
  ];
      ...
      <div className="border-t p-4 shrink-0">
        <div className="flex items-center gap-3">
          <Avatar className="h-8 w-8">
            <AvatarImage src="/placeholder-user.jpg" alt="Mike Driver" />
            <AvatarFallback>MD</AvatarFallback>
          </Avatar>
          <div className="space-y-0.5">
            <p className="text-sm font-medium">Mike Driver</p>
            <p className="text-xs text-muted-foreground">Fleet Operator</p>
          </div>
        </div>
      </div>
    </aside>
