  ...
  const smsTemplates = [
    {
      ...
      name: "Appointment Reminder",
      content:
        "Reminder: You have an appointment at RouteWise Clinic tomorrow at {time}. Reply Y to confirm or call {phone} to reschedule.",
      type: "SMS",
      lastUpdated: "2023-11-15",
      status: "Active",
    },
    {
      id: 2,
      name: "Prescription Ready",
      content: "Your prescription is ready for pickup at RouteWise Pharmacy. We're open until {closing_time} today.",
      type: "SMS",
      lastUpdated: "2023-10-22",
      status: "Active",
    },
              ...
              <div className="space-y-4">
                <div className="grid gap-4 md:grid-cols-2">
                  <div className="space-y-2">
                    ...
                    <Input id="sender-name" defaultValue="RouteWise Clinic" />
                  </div>
                  <div className="space-y-2">
                    <Label htmlFor="sender-email">Sender Email</Label>
                    <Input id="sender-email" defaultValue="notifications@RouteWise-clinic.com" />
                  </div>
                </div>

                <div className="space-y-2">
                  <Label htmlFor="reply-to">Reply-To Email</Label>
                  <Input id="reply-to" defaultValue="support@RouteWise-clinic.com" />
                </div>
